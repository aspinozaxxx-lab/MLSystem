...
from frontend.app.upload_store import StoredUploads, UploadValidationError, sanitize_filename
    ...
    def test_flow_calls_only_mlsystem_api_stages(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            async def fake_store(**kwargs):  # noqa: ANN003
                ...
                return StoredUploads(run_dir, run_dir / "a.geojson", run_dir / "s.txt", "s3://b/frontend/run/", "a.geojson", "s.txt")
