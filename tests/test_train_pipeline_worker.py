...
from mlsystem.src.train_pipeline.worker import run_worker


class TrainPipelineRunnerWorkerTests(unittest.TestCase):
    def test_fake_stages_run_sequentially_and_reach_100(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("mlsystem.src.train_pipeline.worker.stages.run_stage", side_effect=fake_run_stage):
