...
def run_block_parallel_vectorization(
    *,
    ...
    summary = {
        ...
        "area_before_merge_m2": merge_summary.get("area_before_merge_m2"),
        "area_after_dissolve_m2": merge_summary.get("area_after_dissolve_m2"),
        "area_after_final_filter_m2": merge_summary.get("area_after_final_filter_m2"),
        "area_ratio_after_merge_to_before_merge": merge_summary.get("area_ratio_after_merge_to_before_merge"),
        "area_ratio_final_to_before_merge": merge_summary.get("area_ratio_final_to_before_merge"),
