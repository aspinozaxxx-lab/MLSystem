...
def _build_payload(ctx: StageContext, inference_manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "resource": {
            ...
            "batches_ahead": inference_cfg.get("batches_ahead") or 512,
            "max_preprocess_queue": inference_cfg.get("max_preprocess_queue") or 4096,
            "max_spool_bytes": inference_cfg.get("max_spool_bytes") or 128 * 1024 * 1024 * 1024,
            "max_scenes_inflight": inference_cfg.get("max_scenes_inflight") or 32,
            "max_blocks_inflight": inference_cfg.get("max_blocks_inflight") or 32,
        },
